...
Every published record is signed over its canonical JSON form, so the encoding
is part of the contract: sorted keys, no whitespace, ASCII only, no NaN.
"""
...
class Signer:
    """ed25519 signer around a 32-byte seed. The verify key (hex) is the validator's public id."""
