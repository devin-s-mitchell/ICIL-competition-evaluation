...
Unit lists, seeds and lighting draws must be reproducible by anyone from the
published ids, in any language and any Python version. Python's `random`
module does not promise that across versions; a hash counter does.
"""
